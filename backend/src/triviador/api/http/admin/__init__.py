...
from triviador.api.http.admin import categories, imports, media, questions
...
router = build_admin_router(categories.router, imports.router, media.router, questions.router)
